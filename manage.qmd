...
As a UCSB affiliate, you have access to cloud storage solutions such as Google Drive and Box and other departmental computing and storage resources. Check with your departmental IT Team!! 
...
Building analytical workflows or data pipelines empowers you to iterate more quickly and integrate new information more easily. Say goodbye to copy-paste!! It also enables others to build on your work. Your research is important – but arguably only when others can find it, make sense of it, and build from it. You’re constantly collaborating and most importantly with Future You! Develop your workflows in a mindset geared towards collaboration. ***Workflows are rarely linear! They are developed iteratively, and one of the most helpful things you can do is talk about them with your research team.***
