...
Your overarching goal is to archive and share your data in a publicly accessible data repository such as [Dryad](https://datadryad.org/stash) as your project is completing or important milestones are achieved. For you work to be reproducible, metadata and documentation needs to also be developed as well as the scripts you have developed for you analaysis. Here is an example of a previous group archive: <https://doi.org/10.25349/D97G9Z> -- especially look at the `README.md` describing the content.

Before writing your plan, we recommend you getting familiar with the [FAIR](https://www.go-fair.org/fair-principles/) and [CARE](https://www.gida-global.org/care) principles to guide your process.

![source: <https://www.gida-global.org/care>](images/be-FAIR-and-CARE.png)
